        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="text-emerald-600 font-medium hover:underline">View All</button>
            </div>
...
function TicketCard({ status, statusColor, title, park, date, price }) {
  return (
    <div className="border border-gray-200 rounded-2xl p-5 hover:shadow-md transition bg-white">
      <div className="flex justify-between items-start mb-4">
        <span className={`text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide ${statusColor}`}>
          {status}
        </span>
      ...
      <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-50 text-sm">
        <span className="text-gray-500 flex items-center gap-2 font-medium">📅 {date}</span>
