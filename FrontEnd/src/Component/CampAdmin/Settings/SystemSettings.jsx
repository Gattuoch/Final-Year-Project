        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-600 focus:border-transparent w-full md:w-64 bg-white transition-all shadow-sm"
            />
          </div>
        ...
        <div id="backup" className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col scroll-mt-24">
          ...
          <div className="p-4 border border-slate-100 bg-slate-50/50 rounded-lg flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-2">
            ...
            <div className="flex space-x-3">
              <button className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm whitespace-nowrap">
                Restore Database
              </button>
              <button className="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm whitespace-nowrap">
                Run Backup Now
              </button>
            </div>
          </div>
